...
export const messages = StrictDict({
    ...
    certRefundContactBilling: {
        ...
        defaultMessage:
            "If you would like a refund on your Certificate of Achievement, please contact our billing address {billingEmail}",
    },
    ...
    passingGrade: {
        ...
        defaultMessage: "Điểm cần thiết để vượt qua khóa học: {minPassingGrade}\u200f%",
    },
    notEligibleForCert: {
    ...
    entitlementUnavailable: {
        ...
        defaultMessage:
            "There are no sessions available at the moment.  The course team will create new sessions soon.  If no sessions appear, please contact {emailLink} for information.",
    },
    ...
    courseHasNotStarted: {
        ...
        defaultMessage:
            "You can't access this course just yet because the course hasn't started yet. The course will start on {startDate}.",
    },
});
